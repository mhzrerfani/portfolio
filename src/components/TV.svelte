<style>
  ...
  .screen::after {
    ...
    border: 75vw solid #0a0a0a;
    border-left-width: 50vw;
    border-right-width: 50vw;
    animation: turn-on 1s ease 0s 2, turned-on 1s ease 1s infinite;
  }
  .error-effect {
    position: absolute;
    width: 100%;
...
<div class="screen">
  <div class="error-noise">
    <div class="error-effect flex items-center justify-center relative">
      <div class="flex items-center justify-center w-full old-tv-content">
        <slot />
      </div>
    </div>
  </div>
